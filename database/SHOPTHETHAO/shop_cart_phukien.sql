...
--
-- Table structure for table `cart_phukien`
--

DROP TABLE IF EXISTS cart_phukien;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE cart_phukien (
...
--
-- Dumping data for table `cart_phukien`
--

LOCK TABLES cart_phukien WRITE;
/*!40000 ALTER TABLE cart_phukien DISABLE KEYS */;
/*!40000 ALTER TABLE cart_phukien ENABLE KEYS */;
UNLOCK TABLES;
